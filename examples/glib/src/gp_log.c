                           ...
                           gpointer user_data )
{
  ...
  switch (log_level & G_LOG_LEVEL_MASK) {
	 case G_LOG_LEVEL_WARNING:  color = E_BR_YELLOW;  level = "wrn"; /*"warning";*/  lm = log_mask & GP_WARNING;  vm = verbose_mask & GP_WARNING;  break;
	 case G_LOG_LEVEL_ERROR:    color = E_BR_RED;     level = "err"; /*"error";  */  lm = log_mask & GP_ERROR;    vm = verbose_mask & GP_ERROR;    break;
	 case G_LOG_LEVEL_CRITICAL: color = E_WONR;       level = "cri"; /*"critical";*/ lm = log_mask & GP_CRITICAL; vm = verbose_mask & GP_CRITICAL; break;
	 case G_LOG_LEVEL_DEBUG:    color = E_BR_GREEN;   level = "dbg"; /*"debug";  */  lm = log_mask & GP_DEBUG;    vm = verbose_mask & GP_DEBUG;    break;
	 case G_LOG_LEVEL_INFO:     color = E_WHITE;      level = "inf";                 lm = log_mask & GP_INFO;     vm = verbose_mask & GP_INFO;     break;
	 case G_LOG_LEVEL_MESSAGE:  color = E_BR_CYAN;    level = "msg"; /* "message";*/ lm = log_mask & GP_MESSAGE;  vm = verbose_mask & GP_MESSAGE;  break;
